...
const BlogCard = ({image, heading, alt, details, link}) => {
  return (
    <div className='border border-signature border-solid rounded-lg'>
     <Image src={image} alt={alt} height={100} width={300} className="rounded-lg pb-2 w-full h-[45%]  object-cover"/>
    ...
    <Heading as='h3' className="text-xl font-bold">{heading}</Heading>
     ...
     <Button className="px-3 py-[5px] bg-signature rounded-lg text-white hover:bg-hover">Read More</Button>
     </Link>
